...
class DomainA private constructor() {
    ...
    interface Builder {
        ...
        fun productToRemove_(
            whatever: org.partiql.pig.legacy.runtime.SymbolPrimitive,
            metas: MetaContainer = emptyMetaContainer()
        ): DomainA.ProductToRemove =
            DomainA.ProductToRemove(
                whatever = whatever,
         ...
         */
        fun recordToRemove_(
            irrelevant: org.partiql.pig.legacy.runtime.LongPrimitive,
            metas: MetaContainer = emptyMetaContainer()
        ): DomainA.RecordToRemove =
            DomainA.RecordToRemove(
         ...
         */
        fun productA_(
            one: org.partiql.pig.legacy.runtime.LongPrimitive,
            two: ProductToRemove,
            metas: MetaContainer = emptyMetaContainer()
        ): DomainA.ProductA =
            DomainA.ProductA(
        ...
        fun unpermutedProduct_(
            foo: org.partiql.pig.legacy.runtime.SymbolPrimitive,
            bar: org.partiql.pig.legacy.runtime.LongPrimitive,
            metas: MetaContainer = emptyMetaContainer()
        ): DomainA.UnpermutedProduct =
            DomainA.UnpermutedProduct(
                foo = foo,
         ...
         */
        fun willBeReplaced_(
            something: org.partiql.pig.legacy.runtime.LongPrimitive,
            metas: MetaContainer = emptyMetaContainer()
        ): DomainA.SumB.WillBeReplaced =
            DomainA.SumB.WillBeReplaced(
                something = something,
    ...
    class ProductToRemove(
        val whatever: org.partiql.pig.legacy.runtime.SymbolPrimitive,
        ...
        fun copy(
            whatever: org.partiql.pig.legacy.runtime.SymbolPrimitive = this.whatever,
    ...
    class RecordToRemove(
        val irrelevant: org.partiql.pig.legacy.runtime.LongPrimitive,
        override val metas: MetaContainer = emptyMetaContainer()
    ): DomainANode() {
        ...
        fun copy(
            irrelevant: org.partiql.pig.legacy.runtime.LongPrimitive = this.irrelevant,
            metas: MetaContainer = this.metas
        ) =
            RecordToRemove(
                irrelevant,
    ...
    class ProductA(
        val one: org.partiql.pig.legacy.runtime.LongPrimitive,
        ...
        fun copy(
            one: org.partiql.pig.legacy.runtime.LongPrimitive = this.one,
    ...
    class UnpermutedProduct(
        val foo: org.partiql.pig.legacy.runtime.SymbolPrimitive,
        val bar: org.partiql.pig.legacy.runtime.LongPrimitive,
        override val metas: MetaContainer = emptyMetaContainer()
    ): DomainANode() {
        ...
        fun copy(
            foo: org.partiql.pig.legacy.runtime.SymbolPrimitive = this.foo,
            bar: org.partiql.pig.legacy.runtime.LongPrimitive = this.bar,
            metas: MetaContainer = this.metas
        ) =
            UnpermutedProduct(
                foo,
    ...
    sealed class SumB(override val metas: MetaContainer = emptyMetaContainer()) : DomainANode() {
        ...
        class WillBeReplaced(
            val something: org.partiql.pig.legacy.runtime.LongPrimitive,
            override val metas: MetaContainer = emptyMetaContainer()
        ): SumB() {
            ...
            fun copy(
                something: org.partiql.pig.legacy.runtime.LongPrimitive = this.something,
                metas: MetaContainer = this.metas
            ) =
                WillBeReplaced(
                    something,
