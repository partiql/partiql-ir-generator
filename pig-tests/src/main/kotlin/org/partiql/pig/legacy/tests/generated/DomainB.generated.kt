...
class DomainB private constructor() {
    ...
    interface Builder {
         ...
         */
        fun productA_(
            one: org.partiql.pig.legacy.runtime.SymbolPrimitive,
            metas: MetaContainer = emptyMetaContainer()
        ): DomainB.ProductA =
            DomainB.ProductA(
                one = one,
         ...
         */
        fun newProduct_(
            foo: org.partiql.pig.legacy.runtime.LongPrimitive,
            metas: MetaContainer = emptyMetaContainer()
        ): DomainB.NewProduct =
            DomainB.NewProduct(
                foo = foo,
         ...
         */
        fun willBeReplaced_(
            something: org.partiql.pig.legacy.runtime.SymbolPrimitive,
            metas: MetaContainer = emptyMetaContainer()
        ): DomainB.SumB.WillBeReplaced =
            DomainB.SumB.WillBeReplaced(
                something = something,
    ...
    class ProductA(
        val one: org.partiql.pig.legacy.runtime.SymbolPrimitive,
        override val metas: MetaContainer = emptyMetaContainer()
    ): DomainBNode() {
        ...
        fun copy(
            one: org.partiql.pig.legacy.runtime.SymbolPrimitive = this.one,
            metas: MetaContainer = this.metas
        ) =
            ProductA(
                one,
    ...
    class NewProduct(
        val foo: org.partiql.pig.legacy.runtime.LongPrimitive,
        override val metas: MetaContainer = emptyMetaContainer()
    ): DomainBNode() {
        ...
        fun copy(
            foo: org.partiql.pig.legacy.runtime.LongPrimitive = this.foo,
            metas: MetaContainer = this.metas
        ) =
            NewProduct(
                foo,
    ...
    sealed class SumB(override val metas: MetaContainer = emptyMetaContainer()) : DomainBNode() {
        ...
        class WillBeReplaced(
            val something: org.partiql.pig.legacy.runtime.SymbolPrimitive,
            override val metas: MetaContainer = emptyMetaContainer()
        ): SumB() {
            ...
            fun copy(
                something: org.partiql.pig.legacy.runtime.SymbolPrimitive = this.something,
                metas: MetaContainer = this.metas
            ) =
                WillBeReplaced(
                    something,
