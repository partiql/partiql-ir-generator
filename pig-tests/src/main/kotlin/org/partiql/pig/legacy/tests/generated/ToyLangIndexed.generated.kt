...
class ToyLangIndexed private constructor() {
    ...
    interface Builder {
         ...
         */
        fun function_(
            varName: org.partiql.pig.legacy.runtime.SymbolPrimitive,
            body: Expr,
            metas: MetaContainer = emptyMetaContainer()
        ): ToyLangIndexed.Expr.Function =
            ToyLangIndexed.Expr.Function(
    ...
    sealed class Expr(override val metas: MetaContainer = emptyMetaContainer()) : ToyLangIndexedNode() {
        ...
        class Function(
            val varName: org.partiql.pig.legacy.runtime.SymbolPrimitive,
            val body: Expr,
            override val metas: MetaContainer = emptyMetaContainer()
        ): Expr() {
            ...
            fun copy(
                varName: org.partiql.pig.legacy.runtime.SymbolPrimitive = this.varName,
                body: Expr = this.body,
                metas: MetaContainer = this.metas
            ) =
                Function(
