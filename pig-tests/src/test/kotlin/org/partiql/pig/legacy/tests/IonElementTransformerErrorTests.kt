...
import org.partiql.pig.legacy.runtime.MalformedDomainDataException
import org.partiql.pig.legacy.tests.generated.PartiqlBasic
    ...
    companion object {
        ...
        fun parametersForSerializationErrorTest() = listOf(
            ...
            ErrorTestCase(
                ...
                "1:15: Expected 'class org.partiql.pig.legacy.tests.generated.PartiqlBasic${'$'}Expr' but found 'class org.partiql.pig.legacy.tests.generated.PartiqlBasic${'$'}Projection${'$'}ProjectValue'"
            ),
