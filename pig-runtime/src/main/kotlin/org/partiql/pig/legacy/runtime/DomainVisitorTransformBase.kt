...
abstract class DomainVisitorTransformBase {
    ...
    open fun transformBoolPrimitive(b: org.partiql.pig.legacy.runtime.BoolPrimitive): org.partiql.pig.legacy.runtime.BoolPrimitive {
        ...
        return if (b.value != newValue || b.metas !== newMetas) {
            org.partiql.pig.legacy.runtime.BoolPrimitive(newValue, newMetas)
        } else {
            b
        }
    }

    open fun transformBoolPrimitiveValue(sym: org.partiql.pig.legacy.runtime.BoolPrimitive): Boolean = sym.value

    open fun transformBoolPrimitiveMetas(b: org.partiql.pig.legacy.runtime.BoolPrimitive) = transformMetas(b.metas)
